...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Transaction Manager</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link zf41.CO7207.GD_assignment1_EMF.impl.TransactionManagerImpl#getActiveTransaction <em>Active Transaction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransactionManagerImpl extends ManagerImpl implements TransactionManager {
	/**
	...
	protected EClass eStaticClass() {
		return GD_assignment1_EMFPackage.Literals.TRANSACTION_MANAGER;
	}
	...
	public EList<ActiveTransaction> getActiveTransaction() {
		if (activeTransaction == null) {
			activeTransaction = new EObjectWithInverseResolvingEList<ActiveTransaction>(ActiveTransaction.class, this,
					GD_assignment1_EMFPackage.TRANSACTION_MANAGER__ACTIVE_TRANSACTION,
					GD_assignment1_EMFPackage.ACTIVE_TRANSACTION__TRANSACTION_MANAGER);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case GD_assignment1_EMFPackage.TRANSACTION_MANAGER__ACTIVE_TRANSACTION:
